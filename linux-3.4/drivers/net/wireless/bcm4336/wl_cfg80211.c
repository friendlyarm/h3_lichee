...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 16, 0)) || defined(CPTCFG_WIRELESS)
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 1, 0)) || defined(CPTCFG_WIRELESS)
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 14, 0)) || defined(CPTCFG_WIRELESS)
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 0, 0) || defined(CPTCFG_WIRELESS)
...
static s32
#if (((LINUX_VERSION_CODE >= KERNEL_VERSION(3, 6, 0)) || defined(CPTCFG_WIRELESS)) && !defined(WL_COMPAT_WIRELESS))
...
#ifdef CONFIG_PM
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 11, 0)) || defined(CPTCFG_WIRELESS)
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 9, 0)) || defined(CPTCFG_WIRELESS)
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 18, 0)) || defined(CPTCFG_WIRELESS)
	...
	const wl_event_msg_t *e, void *data)
{
	...
	u32 status =  ntoh32(e->status);
	bool active;
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 15, 0) || defined(CPTCFG_WIRELESS)
